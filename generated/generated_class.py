...
class Root(object):
    ...
    def solver(self, value):
        ...
        \nRequired: []
        \nOptional: ['max_threads', 'linear', 'augmented_lagrangian', 'contact', 'rayleigh_damping', 'advanced', 'adjoint_linear', 'nonlinear']
        '''
    ...
    class Geometry(object):
        ...
        class Value(object):
            ...
            \nRequired: ['mesh']
            \nOptional: ['type', 'extract', 'unit', 'transformation', 'volume_selection', 'surface_selection', 'point_selection', 'curve_selection', 'n_refs', 'advanced', 'is_obstacle', 'enabled', 'point', 'normal', 'height', 'mesh_sequence', 'fps', 'array']'''
            class Type(str, Enum):
                MESH = 'mesh'
                PLANE = 'plane'
                GROUND = 'ground'
            ...
            def __init__(
                ...
                height: float = None,
                mesh_sequence: Optional["Root.Geometry.Value.Mesh_sequence"] = None,
                fps: int = None,
                array: Optional["Root.Geometry.Value.Array"] = None
            ):
            ...
            def as_dict(self):
                return drop_none({"mesh": self._mesh,"type": self._type.value if self._type is not None else None,"extract": self._extract.value if self._extract is not None else None,"unit": self._unit,"transformation": self._transformation.as_dict(),"volume_selection": self._volume_selection.as_dict(),"surface_selection": self._surface_selection.as_dict(),"point_selection": self._point_selection.as_dict(),"curve_selection": self._curve_selection.as_dict(),"n_refs": self._n_refs,"advanced": self._advanced.as_dict(),"is_obstacle": self._is_obstacle,"enabled": self._enabled,"point": self._point,"normal": self._normal,"height": self._height,"mesh_sequence": self._mesh_sequence.as_dict(),"fps": self._fps,"array": self._array.as_dict(),})
            ...
            class Transformation(object):
                ...
                def __init__(
                    ...
                    dimensions: Optional["Root.Geometry.Value.Transformation.Dimensions"] = None
                ):
                    ...
                    self._dimensions = type_check(dimensions, self.Dimensions) if dimensions else self.Dimensions()
                ...
                def dimensions(self, value):
                    ...
                    \nOptional: ['float', 'list']
                    '''
                    self._dimensions = type_check(value, self.Dimensions) 
                ...
                def as_dict(self):
                    return drop_none({"rotation_mode": self._rotation_mode,"translation": self._translation,"rotation": self._rotation,"scale": self._scale,"dimensions": self._dimensions.as_dict(),})
                ...
                class Dimensions(object):
                    ...
                    def __init__(
                        ...
                        self._value = class_check(value, [float, list]) if value is not None else None
                    ...
                    def value(self, value):
                        ...
                        This is a polymorphic variable, assign an object from its classes to the value
                        '''
                        self._value = class_check(value, [float, list]) 

                    def check_required(self):

                        if self.value is None:
                            print("Requiered variable Root.Geometry.Value.Transformation.Dimensions.value does not have value")
                        else:
            ...
            class Mesh_sequence(object):
                ...
                def check_required(self):
                    ...
                    if self.value is None:
                        print("Requiered variable Root.Geometry.Value.Mesh_sequence.value does not have value")
                    else:
                        if type(self.value) not in [['int', 'float', 'list', 'str', 'bool']]:
                            self.value.check_required()
                    return
            ...
            class Array(object):
                ...
                def check_required(self):
                    ...
                    if self.offset is None:
                        print("Requiered variable Root.Geometry.Value.Array.offset does not have value")

                    if self.size:
                        print("Requiered variable Root.Geometry.Value.Array.size does not have value")
                    return
        ...
        class Mesh_array(object):
            ...
            class Transformation(object):
                ...
                def __init__(
                    ...
                    rotation: Optional[Iterable[float]] = None,
                    scale: Optional[Iterable[float]] = None,
                    dimensions: Optional["Root.Geometry.Mesh_array.Transformation.Dimensions"] = None
                ):
                    self._rotation_mode = type_check(rotation_mode, str) if rotation_mode is not None else None
                    self._translation = [] if translation is None else [type_check(i, float) for i in translation]
                    self._rotation = [] if rotation is None else [type_check(i, float) for i in rotation]
                ...
                class Dimensions(object):
                    ...
                    def check_required(self):
                        ...
                        if self.value is None:
                            print("Requiered variable Root.Geometry.Mesh_array.Transformation.Dimensions.value does not have value")
                        else:
                            if type(self.value) not in [['int', 'float', 'list', 'str', 'bool']]:
                                self.value.check_required()
                        return
        ...
        class Mesh_sequence(object):
            ...
            class Transformation(object):
                ...
                def __init__(
                    ...
                    rotation: Optional[Iterable[float]] = None,
                    scale: Optional[Iterable[float]] = None,
                    dimensions: Optional["Root.Geometry.Mesh_sequence.Transformation.Dimensions"] = None
                ):
                    self._rotation_mode = type_check(rotation_mode, str) if rotation_mode is not None else None
                    self._translation = [] if translation is None else [type_check(i, float) for i in translation]
                    self._rotation = [] if rotation is None else [type_check(i, float) for i in rotation]
                ...
                class Dimensions(object):
                    ...
                    def check_required(self):
                        ...
                        if self.value is None:
                            print("Requiered variable Root.Geometry.Mesh_sequence.Transformation.Dimensions.value does not have value")
                        else:
                            if type(self.value) not in [['int', 'float', 'list', 'str', 'bool']]:
                                self.value.check_required()
                        return
    ...
    class Time(object):
        ...
        class Object1(object):
            ...
            def as_dict(self):
                return drop_none({"tend": self._tend,"dt": self._dt,"t0": self._t0,"time_steps": self._time_steps,"object3": self._object3.as_dict(),"quasistatic": self._quasistatic,})
    ...
    class Solver(object):
        ...
        def as_dict(self):
            return drop_none({"max_threads": self._max_threads,"linear": self._linear,"augmented_lagrangian": self._augmented_lagrangian.as_dict(),"contact": self._contact.as_dict(),"rayleigh_damping": self._rayleigh_damping.as_dict(),"advanced": self._advanced.as_dict(),"adjoint_linear": self._adjoint_linear,"nonlinear": self._nonlinear,})
            ...
            class Object1(object):
                ...
                def check_required(self):
                    ...
                    if self.form is None:
                        print("Requiered variable Root.Solver.Rayleigh_damping.Object1.form does not have value")

                    if self.stiffness_ratio is None:
                        print("Requiered variable Root.Solver.Rayleigh_damping.Object1.stiffness_ratio does not have value")
                    return
    ...
    class Boundary_conditions(object):
        ...
        class Dirichlet_boundary(object):
            ...
            class Object1(object):
                ...
                def __init__(
                    self,
                    value: Optional["Root.Boundary_conditions.Dirichlet_boundary.Object1.Value"] = None
                ):
                ...
                def value(self, value):
                    ...
                    \nRequired: []
                    \nOptional: ['value', 'dimension', 'time_reference']
                    '''
                ...
                def as_dict(self):
                    return drop_none({"value": self._value.as_dict(),})
                ...
                class Value(object):
                    ...
                    def __init__(
                        ...
                        self._items = [class_check(i, [self.Value, self.Dimension, self.Time_reference]) for i in (type_check(items, list) if items else [])]
                    ...
                    def add(self, item : object):
                        ''' Add to the list '''
                        self._items.append(class_check(item, [self.Value, self.Dimension, self.Time_reference]))
                    ...
                    def check_required(self):
                        ...
                        if self.items:
                            ...
                            print("Requiered variable Root.Boundary_conditions.Dirichlet_boundary.Object1.Value.items does not have value")
                        return

                    def as_dict(self):
                        return drop_none([i.as_dict() if isinstance(i, tuple([self.Value, self.Dimension, self.Time_reference])) else i for i in self._items])
            ...
            class Object2(object):
                ...
                def check_required(self):
                    ...
                    if self.value is None:
                        print("Requiered variable Root.Boundary_conditions.Dirichlet_boundary.Object2.value does not have value")
                    return
        ...
        class Neumann_boundary(object):
            ...
            class Object1(object):
                ...
                def as_dict(self):
                    return drop_none({"value": self._value,})
